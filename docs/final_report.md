...
The model table is split temporally: the first 80% of unique dates go to training, the last 20% to testing. This gives us 292 training dates (Jan 1 -- Oct 18) and 73 test dates (Oct 19 -- Dec 30). We do not shuffle rows -- that would leak future information into training.
